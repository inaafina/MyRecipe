...
public class ControllerRegister {
    ...
    public int Regist() {
        ...
        if (!frame.getjUsername().getText().isEmpty() & !frame.getjName().getText().isEmpty() & !frame.getjPassword().getText().isEmpty() & !frame.getjConPassword().getText().isEmpty()) { // kondisi ideal
            User user = new User();
